...
export default function ToolHome({login}: { login: LoginInfo }) {
    ...
    return <main className="tool-home">
        ...
        <section className="catalog-intro">
            ...
            {login.canCreateTools &&
                <div className="panel-actions"><a className="button" href="/workspace">进入开发工作台</a>
                    <a className="button primary" href="/workspace/new">＋ 制作新工具</a></div>}</section>
